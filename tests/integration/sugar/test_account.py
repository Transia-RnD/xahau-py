...
from xahau.asyncio.account import (
    does_account_exist,
    get_balance,
...
class TestAccount(IntegrationTestCase):
    ...
    @test_async_and_sync(globals(), ["xahau.account.get_balance"])
    ...
    @test_async_and_sync(globals(), ["xahau.account.get_latest_transaction"])
    async def test_get_latest_transaction(self, client):
        ...
        # print(response.result["transactions"][0])
